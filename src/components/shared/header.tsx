        ...
        <div className='px-0.5 flex items-center justify-between py-4 '>
          ...
          <div className='flex items-center gap-8'>
            ...
            {isAuthenticated && profile ? (
              ...
              <>
                <Link to={path.signin} className='py-1 hover:border-b hover:border-b-[#009e0f]'>
                  Sign in
                </Link>
                <Link
                  to={path.signup}
                  className='text-[#009e0f] bg-transparent border border-[#009e0f] hover:cursor-pointer hover:bg-[#009e0f] hover:text-white transition-all duration-100 px-4 py-1 rounded-sm'
                >
                  Join
                </Link>
              </>
